...
apk_target = \
	$(call apk,$(mkfs_cur_target_dir)) \
	--repository file://$(PACKAGE_DIR_ALL)
...
target-dir-%: FORCE
	...
	$(if $(call apk_package_files,$(mkfs_packages_add)), \
		$(apk_target) update && \
		$(apk_target) add \
			$(call apk_package_files,$(mkfs_packages_add)))
	-mv$(mkfs_cur_target_dir).repositories $(mkfs_cur_target_dir)/etc/apk/
