...
$(_endef)
	...
	(cd $$(IDIR_$(1)) && find . > $$(IDIR_$(1))/lib/apk/packages/$(1).list)
	...
	$(FAKEROOT) $(STAGING_DIR_HOST)/bin/apk mkpkg \
	  ...
	  --info "origin:$(SOURCE)" \
	  $$(foreach prov,$$(filter-out $(1)$$(ABIV_$(1)),$(PROVIDES)$$(if $$(ABIV_$(1)), \
		$(1) $(foreach provide,$(PROVIDES),$(provide)$$(ABIV_$(1))))),--info "provides:$$(prov)=0") \
	  $$(if $(MAINTAINER),--info "maintainer:$(MAINTAINER)") \
	  $$(if $$(ABIV_$(1)),--info "abi:$$(ABIV_$(1))") \
